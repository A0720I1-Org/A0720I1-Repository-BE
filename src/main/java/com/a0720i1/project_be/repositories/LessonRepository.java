...
public interface LessonRepository extends JpaRepository<Lesson, Integer> {
    ...
    //Duy
    @Query(value = "select subject.name as subjectName, lesson_time.lesson_date as lessonDate, lesson_time.lesson_number as lessonNumber, teacher.name as teacherName from lesson_time\n" +
